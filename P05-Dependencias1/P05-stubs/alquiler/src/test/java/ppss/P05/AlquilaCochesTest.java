...
public class AlquilaCochesTest {
    ...
    void calculaPrecioC3() {
        ...
        servStub.setPrecio(precioDia);
        ArrayList<LocalDate> exceptions = new ArrayList<>();
        exceptions.add(LocalDate.of(2022, Month.APRIL, 18));
        exceptions.add(LocalDate.of(2022, Month.APRIL, 21));
        exceptions.add(LocalDate.of(2022, Month.APRIL, 22));
        calStub.setException(exceptions);
